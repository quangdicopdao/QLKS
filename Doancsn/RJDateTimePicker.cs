...
public class RJDatePicker : DateTimePicker
{
    ...
    private Image calendarIcon = Doancsn.Properties.Resources.calendarWhite;
    ...
    public Color SkinColor
    {
        ...
        set
        {
            ...
            if (skinColor.GetBrightness() >= 0.8F)
                calendarIcon = Doancsn.Properties.Resources.calendarDark;
            else calendarIcon = Doancsn.Properties.Resources.calendarWhite;
            this.Invalidate();
        }
    }
